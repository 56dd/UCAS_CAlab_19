...
HD_PWD='D:/aaa/UCAS_CAlab_19/exp20/mycpu_env/cache_verify/run_vivado/project/loongson.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cache_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cache_top.tcl
