...
HD_PWD='D:/aaa/UCAS_CAlab_19/exp20/mycpu_env/cache_verify/run_vivado/project/loongson.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cache_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cache_top.tcl -notrace
