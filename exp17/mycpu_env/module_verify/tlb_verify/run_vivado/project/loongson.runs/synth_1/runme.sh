...
HD_PWD='D:/aaa/UCAS_CAlab_19/exp17/mycpu_env/module_verify/tlb_verify/run_vivado/project/loongson.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tlb_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tlb_top.tcl
