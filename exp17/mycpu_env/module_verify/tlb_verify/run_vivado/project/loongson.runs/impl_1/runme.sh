...
HD_PWD='D:/aaa/UCAS_CAlab_19/exp17/mycpu_env/module_verify/tlb_verify/run_vivado/project/loongson.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tlb_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tlb_top.tcl -notrace
